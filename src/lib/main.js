...
import uni_1_fbx from "$assets/3D/uni_1.fbx";
import uni_2_fbx from "$assets/3D/uni_2.fbx";
import uni_3_fbx from "$assets/3D/uni_3.fbx";
import uni_4_fbx from "$assets/3D/uni_4.fbx";
...
export function init() {
    ...
    // Load models
    loadModel(loader, uni_1_fbx, 'Floor 1');
    loadModel(loader, uni_2_fbx, 'Floor 2');
    loadModel(loader, uni_3_fbx, 'Floor 3');
    loadModel(loader, uni_4_fbx, 'Floor 4');
